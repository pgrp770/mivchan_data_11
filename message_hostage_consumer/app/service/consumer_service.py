...
from message_hostage_consumer.app.repository.insertion_repository import create_user, create_location, \
    create_device_info, create_hostage_sentence
...
def insert_message_to_postgres_hostages(consumer_message):
